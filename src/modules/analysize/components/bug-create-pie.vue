<template>
  <div id="bug-create-pie" v-loading="loading"></div>
</template>
  ...
  methods: {
    ...
    findCreateBugList () {
      return new Promise((resolve, reject) => {
        ...
        this.$http.post('/group/sumBugCreate', { sDate: t, eDate: e }).then((res) => {
          if (res && res.data) {
            resolve(res.data)
          }
        })
    ...
    drawChart () {
      this.chart = echarts.init(document.getElementById('bug-create-pie'))
